"""Main-only: activate with ip_global_auto=true (diagnostic: does NAT/global-IP
participation unblock outbound handshake packets without an interface address?)."""
