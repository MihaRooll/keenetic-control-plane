...
**Phase 0a (architecture evidence) завершена.** **Phase 0b (contracts) — in progress.** Wave 1 complete: RCI policy, hardware safety gates и security/operations ([`docs/contracts/`](docs/contracts/)). Остаются API, persistence, test strategy, scenarios, roadmap и AI handoff.
...
9. [`docs/contracts/`](docs/contracts/) — Phase 0b formal contracts (Wave 1: RCI policy, hardware gates, security/ops).
