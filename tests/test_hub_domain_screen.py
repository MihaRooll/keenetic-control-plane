...
def test_domain_connectivity_offline_invalidates_operations() -> None:
    """domain-connection-offline-invalidate: offline connectivity invalidates in-flight domain ops."""
    source = _read(DOMAIN_SCREEN_JS)
    ...
    assert "invalidateOperations()" in offline_block
    invalidate_idx = offline_block.find("invalidateOperations()")
